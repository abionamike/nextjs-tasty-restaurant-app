  ...
  return (
    <section id="Contact" class="relative py-16 my-16 md:my-24 md:py-24">
      <div className="container flex flex-col items-center justify-center m-auto">
        ...
        <div className="flex flex-col m-auto items-center justify-center md:flex-row w-4/5">
          <img src="/dinner-03.jpg" alt="Contact our customer support" class="rounded-xl md:h-96 md:w-auto" />
          <form onSubmit={handleSubmit} class="space-y-6 md:ml-20 w-full mt-8 md:mt-0">
            <h1 className="title-font ext-gray-bgColor2 text-2xl font-semibold">Drop Us A Message!</h1>
            <div>
