const Services = () => {
  return ( 
    <section id="Services" className="text-gray-600 body-font">
      <div className="container w-10/12 flex flex-col lg:px-5 py-24 mx-auto">
        ...
        <div className="flex flex-col md:space-x-8 lg:space-x-14 items-center justify-center md:flex-row text-center">
