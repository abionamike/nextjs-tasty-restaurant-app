const Services = () => {
  return ( 
    <section id="Services" className="text-gray-600 body-font">
      <div className="container w-11/12 flex flex-col lg:px-5 py-24 mx-auto">
        ...
        <div className="flex flex-col md:space-x-4 lg:space-x-6 items-center justify-center md:flex-row text-center">
          <div className="relative md:w-1/4 w-10/12 mb-10 shadow-lg">
            <div className="rounded-lg h-64 overflow-hidden">
              <img alt="content" className="object-cover object-center h-full w-full" src="/booking-02.jpg" />
            </div>
            <div className="absolute left-1 bottom-10 text-center text-xl text-yellow-700 font-semibold rounded-full p-3 bg-gray-100 shadow-lg">01.</div>
          ...
          <div className="relative md:w-1/4 w-10/12 mb-10 shadow-lg">
            ...
            <div className="absolute left-1 bottom-10 text-center text-xl text-yellow-700 font-semibold rounded-full p-3 bg-gray-100 shadow-lg">02.</div>
          ...
          <div className="relative md:w-1/4 w-10/12 mb-10 shadow-lg">
            ...
            <div className="absolute left-1 bottom-10 text-center text-xl text-yellow-700 font-semibold rounded-full p-3 bg-gray-100 shadow-lg">03.</div>
