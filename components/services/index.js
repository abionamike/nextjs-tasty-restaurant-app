const Services = () => {
  return ( 
    <section id="Services" className="text-gray-600 body-font">
      <div className="container w-11/12 m-auto flex flex-col lg:px-5 py-24 mx-auto">
        ...
        <div className="flex flex-col m-auto items-center justify-center w-10/12 md:flex-row text-center">
          <div className="relative md:w-1/4 w-full mb-10 mx-4 shadow-lg">
