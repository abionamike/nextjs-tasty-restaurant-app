      ...
      <div className="container w-11/12 m-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative">
            <div className="absolute uppercase py-4 px-6 text-lg rounded-md bg-gray-100 tracking-widest hover:bg-yellow-600 hover:text-gray-100 opacity-90 left-36 top-24  font-semibold">Drinks</div>
            <img src="/our-menu-08.jpg" className="w-full h-full rounded-lg" alt=""/>
          </div>
          <div className="relative">
            <div className="absolute uppercase py-4 px-6 text-lg rounded-md bg-gray-100 tracking-widest hover:bg-yellow-600 hover:text-gray-100 opacity-90 left-36 top-24  font-semibold">Starters</div>
            <img src="/our-menu-10.jpg" className="w-full h-full rounded-lg" alt=""/>
          </div>
          <div className="relative md:col-span-2">
            <div className="absolute uppercase py-4 px-6 text-lg rounded-md bg-gray-100 tracking-widest hover:bg-yellow-600 hover:text-gray-100 opacity-90 left-80 top-24  font-semibold">Happy Hour</div>
            <img src="/our-menu-13.jpg" className="w-full h-full rounded-lg" alt=""/>
          </div>
          <div className="relative">
            <div className="absolute uppercase py-4 px-6 text-lg rounded-md bg-gray-100 tracking-widest hover:bg-yellow-600 hover:text-gray-100 opacity-90 left-36 top-24  font-semibold">Dessert</div>
